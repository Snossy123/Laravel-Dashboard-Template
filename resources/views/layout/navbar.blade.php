  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light"
      style="{{ app()->getLocale() == 'ar' ? 'margin-left: 0 !important;' : '' }}">
      <!-- Left navbar links -->
      <ul class="navbar-nav">
          <li class="nav-item">
          ...
          <li class="nav-item d-none d-sm-inline-block">
              <a href="index3.html" class="nav-link">{{ __('adminlte.home') }}</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
              <a href="#" class="nav-link">{{ __('adminlte.contact') }}</a>
          </li>
      </ul>
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-md dropdown-menu-right text-center">
                  <a href="{{LaravelLocalization::getLocalizedURL('ar')}}" class="dropdown-item">
                      <img src="{{asset('assets/img/saudi-arabia.png')}}" style="width: 20px;"> {{__('adminlte.arabic')}}
                  </a>
                  <div class="dropdown-divider"></div>
                  <a href="{{LaravelLocalization::getLocalizedURL('en')}}" class="dropdown-item">
                    <img src="{{asset('assets/img/united-states.png')}}" style="width: 20px;"> {{__('adminlte.english')}}
                  </a>
